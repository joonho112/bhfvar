...
Interval calibration is a separate question. A simulation study of 400
fits under the article's design family found central 90\\ nominal rates
for the primary estimands, but coverage is not established for other
designs and no variance adjustment is implemented. The restricted-data
